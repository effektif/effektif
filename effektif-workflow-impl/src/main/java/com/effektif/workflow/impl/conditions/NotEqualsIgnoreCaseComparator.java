 ...
 * @author Tom Baeyens
 */
@RestType("notEqualsIgnoreCase")
public class NotEqualsIgnoreCaseComparator extends EqualsIgnoreCaseComparator {
  ...
  public String toString(ExecutionContext executionContext) {
    return "( "+left.toString(executionContext)+" not equal to ignore case "+right.toString(executionContext)+" )";
  }
