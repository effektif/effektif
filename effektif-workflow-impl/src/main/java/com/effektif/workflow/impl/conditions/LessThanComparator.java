...
public class LessThanComparator extends Comparator {
  ...
  public boolean compare(TypedValue leftTypedValue, TypedValue rightTypedValue, ExecutionContext executionContext) {
    ...
    if (leftTypedValue.type!=null 
        && leftTypedValue.type.getClass()==Types.NUMBER.getClass()
        && rightTypedValue.type!=null
  ...
  public String toString(ExecutionContext executionContext) {
    return "( "+left.toString(executionContext)+" less than "+right.toString(executionContext)+" )";
  }
