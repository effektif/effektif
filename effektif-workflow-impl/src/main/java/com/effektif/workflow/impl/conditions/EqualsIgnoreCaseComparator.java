 ...
 * @author Tom Baeyens
 */
@RestType("equalsIgnoreCase")
public class EqualsIgnoreCaseComparator extends Comparator {
  ...
  public String toString(ExecutionContext executionContext) {
    return "( "+left.toString(executionContext)+" equals ignore case "+right.toString(executionContext)+" )";
  }
