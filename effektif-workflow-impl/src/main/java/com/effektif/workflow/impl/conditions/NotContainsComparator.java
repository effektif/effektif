 ...
 * @author Tom Baeyens
 */
@RestType("notContains")
public class NotContainsComparator extends ContainsComparator {
  ...
  public String toString(ExecutionContext executionContext) {
    return "( "+left.toString(executionContext)+" does not contain "+right.toString(executionContext)+" )";
  }
