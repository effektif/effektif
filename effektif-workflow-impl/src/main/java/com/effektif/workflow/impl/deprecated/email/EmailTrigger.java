 ...
 *
 * <p>When you use an email trigger, you provide either an {@link com.effektif.workflow.api.deprecated.model.EmailId} for a
...
public class EmailTrigger extends Trigger {
  ...
  /**
   * Returns the variable ID to use to look up the {@link com.effektif.workflow.api.deprecated.model.EmailId},
