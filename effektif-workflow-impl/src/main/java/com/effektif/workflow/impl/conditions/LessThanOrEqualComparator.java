 ...
 * @author Tom Baeyens
 */
@RestType("lessThanOrEqual")
public class LessThanOrEqualComparator extends Comparator {
  ...
  public String toString(ExecutionContext executionContext) {
    return "( "+left.toString(executionContext)+" less than or equal to "+right.toString(executionContext)+" )";
  }
}
